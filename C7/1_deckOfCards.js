...
class Table {
    ...
    join(player) {
        if (this.players.length > 5) console.log('player is full');
        else if (this.players.indexOf(player) > -1) console.log('player is already on table');
    ...
    runGame() {
        ...
        if (players.length === 0) console.log('no players on table: game did not take place');
        else {
